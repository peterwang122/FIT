...
const COLLECTION_TARGET_OPTIONS: CollectionTargetOption[] = [
  ...
  {
    value: 'index_csi_dividend_daily',
    label: '中证红利指数日更',
    group: '独立日更',
    marketScope: 'cn_stock',
    targetType: null,
    requiresTargetSelection: false,
    description: '中证官网仅承诺交易日每日发布；17:10 起在同一条记录内每 5 分钟检查，发布后写入。',
  },
  {
  ...
  },
  {
    ...
    targetType: null,
    requiresTargetSelection: false,
    description: '09:10 从新浪日 K 更新 7 个货币对；只写入已结算交易日，缺任一货币对即不判成功。',
  },
  {
    value: 'forex_intraday',
    label: '汇率18时盘中更新',
    group: '全球市场日更',
    marketScope: 'us_index',
    targetType: null,
    requiresTargetSelection: false,
    description: '18:00 写入新浪当天盘中 OHLC；次日09:10的已结算日更会按同一交易日覆盖更新。',
  },
  {
    ...
    targetType: null,
    requiresTargetSelection: false,
    description: '09:15 从新浪 DXY 日 K 更新美元指数；排除北京时间当天尚未结算的 K 线。',
  },
  {
    value: 'usd_index_intraday',
    label: '美元指数18时盘中更新',
    group: '全球市场日更',
    marketScope: 'us_index',
    targetType: null,
    requiresTargetSelection: false,
    description: '18:00 写入新浪当天 DXY 盘中 OHLC；次日09:15的已结算日更会按同一交易日覆盖更新。',
  },
  {
    value: 'futures_daily',
    label: '中金所期货日更',
  ...
  },
  {
    ...
    targetType: null,
    requiresTargetSelection: false,
    description: '17:00采集上交所、深交所全部ETF指数期权合约与官方日K量额，供17:30看板计算。',
  },
  {
    value: 'exchange_option_stats_daily',
    label: '沪深交易所期权官方统计补齐',
    group: 'A股日更主链',
    marketScope: 'cn_stock',
    targetType: null,
    requiresTargetSelection: false,
    description: '21:10补齐交易所晚间发布的产品成交与持仓统计，上交所5个、深交所4个产品齐全才成功。',
  },
  {
    value: 'option_minute_daily',
    label: '期权分钟行情采集',
    group: 'A股日更主链',
    marketScope: 'cn_stock',
    targetType: null,
    requiresTargetSelection: false,
    description: '交易日09:25启动，盘中逐分钟采集中金所及沪深交易所期权，15:00后汇总并校验十个VIX来源。',
  },
  {
  ...
  {
    value: 'cn_bank_liquidity_daily',
    label: '银行流动性日更',
    group: 'A股日更主链',
    marketScope: 'cn_stock',
    targetType: null,
    requiresTargetSelection: false,
    description: '22:10采集中国货币网定盘与日终回购、中债1年期曲线和央行公开市场操作；单条记录内每3分钟检查到22:25。',
  },
  {
    value: 'cn_macro_daily',
    label: 'A股宏观指标日更',
    group: 'A股日更主链',
    marketScope: 'cn_stock',
    targetType: null,
    requiresTargetSelection: false,
    description: '采集指数估值、10年国债收益率、三所A股市值，并检查居民存款与季度GDP更新，计算宏观指标。',
  },
  {
    value: 'margin_trading_daily',
    label: 'A股融资融券日更',
    group: 'A股日更主链',
    marketScope: 'cn_stock',
    targetType: null,
    requiresTargetSelection: false,
    description: '下一交易日09:20开始检查上一交易日沪深北三所官方融资融券汇总，单条记录内轮询到09:35；三所齐全才成功。',
  },
  {
    value: 'fund_purchase_limit_daily',
    label: 'A股公募基金限购日更',
    group: 'A股日更主链',
    marketScope: 'cn_stock',
    targetType: null,
    requiresTargetSelection: false,
    description: '采集境内权益类开放式公募基金申购状态，按基金产品去重统计大额限购家数；普通暂停申购保留原始记录但不计入指标。',
  },
  {
    value: 'global_risk_daily',
    label: '全球冲击因子日更',
    group: 'A股日更主链',
    marketScope: 'cn_stock',
    targetType: null,
    requiresTargetSelection: false,
    description: '16:10更新KOSPI、SOX、IXN/ACWI、原油和COMEX铜，并回看最近10个交易日修复延迟发布数据。',
  },
  {
    value: 'a_share_turnover_concentration_daily',
    label: 'A股成交集中度日更',
    group: 'A股日更主链',
    marketScope: 'cn_stock',
    targetType: null,
    requiresTargetSelection: false,
    description: '22:05采集公开前5%成交集中度，并用沪深北逐股成交额计算前1%集中度；单条记录内等待到22:25。',
  },
  {
  ...
  },
  {
    ...
    requiresTargetSelection: false,
    calendarDaily: true,
    description: '每天19:00启动一次任务，任务内部每分钟检查指定抖音博主主页；发现当天新作品后通过 Coze 提取四大指数情绪并停止，21:00仍未更新则在同一条执行记录中标记未更新。',
  },
  {
  ...
  {
    value: 'index_us_option_premium_daily',
    label: '美股期权成交额 P/C 日更',
    group: '独立日更',
    marketScope: 'us_index',
    targetType: null,
    requiresTargetSelection: false,
    description: '采集 Optionomics 公共网页展示的 Call/Put 成交额，按0.1M美元精度保存。',
  },
  {
    value: 'index_us_option_price_pc_daily',
    label: '美股ETF期权价格 P/C 日更',
    group: '独立日更',
    marketScope: 'us_index',
    targetType: null,
    requiresTargetSelection: false,
    description: '采集 Nasdaq 公共网页的 SPY/QQQ 真实收盘成交，按当月、下月、季月1、季月2计算价格 P/C。',
  },
  {
